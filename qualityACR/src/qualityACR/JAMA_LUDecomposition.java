...
public class JAMA_LUDecomposition implements java.io.Serializable {
	...
	public JAMA_LUDecomposition(final JAMA_Matrix A) {
	...
	public JAMA_Matrix solve(final JAMA_Matrix B) {
		...
		final JAMA_Matrix Xmat = B.getMatrix(piv, 0, nx - 1);
