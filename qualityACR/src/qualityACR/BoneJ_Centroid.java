...
public class BoneJ_Centroid {
	 ...
	 * @return
	 */
	public static double[] getCentroid(final ArrayList<BoneJ_Point> points) {
		double xsum = 0;
		double ysum = 0;
		double zsum = 0;
		final double n = points.size();

		for (final BoneJ_Point p : points) {
			xsum += p.x;
			ysum += p.y;
			zsum += p.z;
		}
	 ...
	 */
	public static BoneJ_Point getCentroidPoint(ArrayList<BoneJ_Point> points) {
