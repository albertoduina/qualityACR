...
public class JAMA_EigenvalueDecomposition implements java.io.Serializable {
		...
		for (int l = 0; l < n; l++) {
			...
			if (m > l) {
				...
				do {
					...
					double r = JAMA_Maths.hypot(p, 1.0);
					if (p < 0) {
						r = -r;
					}
					d[l] = e[l] / (p + r);
	...
	public JAMA_EigenvalueDecomposition(final JAMA_Matrix Arg) {
